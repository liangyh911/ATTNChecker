...
checkpoint = 'gpt2'
# checkpoint = "./GPT2ABFT/checkpoint-1"
# checkpoint = "./GPT2PRE/checkpoint-1000"
# checkpoint = "./GPT2PRE_2/checkpoint-1000"
# checkpoint = "./GPT2PRE_3/checkpoint-1000"
# checkpoint = "./GPT2PRE_4/checkpoint-1000"
...
fr =  open("./ABFT_running_time/gpt2Cache.txt", "r")
Lines = fr.readlines()
