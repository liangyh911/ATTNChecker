...
class GPT2Attention(nn.Module):
    def __init__(self, config, is_cross_attention=False, layer_idx=None):
        ...
        if self.is_cross_attention:
            ...
            # self.Wq = Conv1D(self.embed_dim, self.embed_dim)
            # self.Wk = Conv1D(self.embed_dim, self.embed_dim)
            # self.Wv = Conv1D(self.embed_dim, self.embed_dim)
        ...
        self.LinFP = "/home/exouser/control/IFLinearABFT.txt"
        self.colFP = "/home/exouser/control/abftCOL_FT.txt"
        self.rowFP = "/home/exouser/control/abftROW_FT.txt"
        self.matFP = "/home/exouser/control/IFABFT.txt"
    ...
    def forward(
        ...
        if encoder_hidden_states is not None:
            ...
            # print("no encoder hidden states")
            with open(self.QKV, 'w') as frQKV:
                frQKV.truncate(0)
                frQKV.write("v")
            # if(num_encoderLayer == 0):
